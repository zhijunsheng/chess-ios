...
class BishopTests: XCTestCase {
    ...
    func testBishopRules() {
        ...
        /*
         ...
         7 . . b . . . . .
         */
        XCTAssertFalse(game.isValid(fromCol: 2, fromRow: 7, toCol: 3, toRow: 5, isWhite: true))
        ...
        /*
         ...
         7 . . b . . . . .
         */
        XCTAssertTrue(game.isValid(fromCol: 2, fromRow: 7, toCol: 4, toRow: 5, isWhite: true))
        ...
        /*
         ...
         7 . . b . . . . .
         */
        XCTAssertTrue(game.isValid(fromCol: 2, fromRow: 7, toCol: 7, toRow: 2, isWhite: true))
        ...
        XCTAssertFalse(game.isValid(fromCol: 2, fromRow: 7, toCol: 4, toRow: 5, isWhite: true))
