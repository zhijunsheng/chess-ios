...
//        originY = (bounds.height - cellSide * 8) / 2
        ...
        for i in 0..<4 {
            ...
            drawSquare(col: i * 2 + 1, row: 3, color: #colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0))
            drawSquare(col: i * 2, row: 4, color: #colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0))
            ...
            drawSquare(col: i * 2 + 1, row: 0, color: #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1))
            drawSquare(col: i * 2, row: 1, color: #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1))
            drawSquare(col: i * 2 + 1, row: 2, color: #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1))
            drawSquare(col: i * 2, row: 3, color: #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1))
            drawSquare(col: i * 2 + 1, row: 4, color: #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1))
            drawSquare(col: i * 2, row: 5, color: #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1))
            drawSquare(col: i * 2 + 1, row: 6, color: #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1))
            drawSquare(col: i * 2, row: 7, color: #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1))
        }
