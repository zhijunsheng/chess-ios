...
class GameViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let bKing: UIImageView = UIImageView(frame: CGRect(x: 60 + originX + side * 3, y: 100 + originY, width: side, height: side))
        bKing.image = #imageLiteral(resourceName: "king_chess_b")
        view.addSubview(bKing)
        let bQueen: UIImageView = UIImageView(frame: CGRect(x: 60 + originX + side * 4, y: 100 + originY, width: side, height: side))
        ...
        let wKing: UIImageView = UIImageView(frame: CGRect(x: 60 + originX + side * 3, y: 100 + originY + side * 7, width: side, height: side))
        wKing.image = #imageLiteral(resourceName: "king_chess_w")
        view.addSubview(wKing)
        let wQueen: UIImageView = UIImageView(frame: CGRect(x: 60 + originX + side * 4, y: 100 + originY + side * 7, width: side, height: side))
